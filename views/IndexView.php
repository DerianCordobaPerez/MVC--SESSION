...
class IndexView {
    ...
    public function show_index(string $title): void {
        ...
        $this->show_header(array('Practica #05', 'MVC - Autentication'));
        ...
        echo Button::button('btn btn-primary my-4 button-width', 'logout', '<a class="link" href="index.php?module=login&action=register">Registrar administrador</a>');
        echo Button::button('btn btn-danger button-width', 'logout', '<a class="link" href="index.php?module=login&action=logout">Cerrar sesion</a>');
